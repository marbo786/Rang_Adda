...
class _RoundTableWidgetState extends State<RoundTableWidget>
                ...
                child: Stack(
                  ...
                  children: [
                    ...List.generate(n, (i) {
                      ...
                      String playerId = i < widget.playerIds.length
                          ? widget.playerIds[i]
                          : '';
                      PlayingCard? playedCard =
                          widget.currentTrickPlays[playerId];
                    ...
                    ...List.generate(n, (i) {
                      ...
                      int cards = i < widget.cardCounts.length
                          ? widget.cardCounts[i]
                          : 0;
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  border: Border.all(
                                    color: isActive
                                        ...
                                        : AppTheme.textDisabled.withValues(
                                            alpha: 0.3,
                                          ),
                                    width: 2,
                                  ),
