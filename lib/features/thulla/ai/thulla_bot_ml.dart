...
class ThullaBotML extends ThullaBot {
  ...
  static Future<void> initialize() async {
    try {
      ...
      debugPrint('TFLite ML bot model loaded successfully.');
    } catch (e) {
      debugPrint('Failed to load TFLite ML bot model: $e');
    }
  }
  ...
  PlayingCard chooseCard(ThullaBotObservation obs) {
    ...
    try {
      ...
      debugPrint('ML inference failed, falling back to medium: $e');
      return ThullaBotMedium(personality).chooseCard(obs);
    }
